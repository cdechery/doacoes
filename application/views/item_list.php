...
?>
	...
	<?php
		if( count($item['imagens']) ) {
				$thumb = thumb_filename($item['imagens'][0], 200);
	?>
	...
	?>	
		...
		<div>
			<input type="button" value="Modificar" onClick="location.href='<?php echo base_url('item/modify/'.$item_id)?>';"> <input type="button" value="Apagar">
		</div>
	</div>
<?php
	}
